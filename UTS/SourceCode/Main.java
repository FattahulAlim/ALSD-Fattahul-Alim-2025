...
public class Main {
    public static void main(String[] args) {
        ...
        Absensi absen1 = new Absensi(mhs[0], mk[0], 10, 1, 1, 0);
        Absensi absen2 = new Absensi(mhs[0], mk[1], 12, 0, 1, 1);
        Absensi absen3 = new Absensi(mhs[1], mk[0], 14, 0, 0, 0);
        Absensi absen4 = new Absensi(mhs[2], mk[1], 9, 2, 1, 2);
        Absensi absen5 = new Absensi(mhs[2], mk[2], 10, 0, 0, 2);
        Absensi absen6 = new Absensi(mhs[3], mk[2], 13, 0, 0, 0);
        Absensi absen7 = new Absensi(mhs[4], mk[0], 11, 1, 1, 1);

        DataAbsensi data = new DataAbsensi();
        data.tambahData(absen1);
        data.tambahData(absen2);
        data.tambahData(absen3);
        data.tambahData(absen4);
        data.tambahData(absen5);
        data.tambahData(absen6);
        data.tambahData(absen7);
        ...
        do {
            ...
            System.out.println("6. Mencari data mahasiswa dengan alpha paling banyak");
            ...
            switch (pilihan) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    System.out.println("=== HASIL PENCARIAN APHA MAHASISWA TERBANYAK ===");
                    data.cariAlpha();
                    break;
                case 0:
    ...
    //     for(int j = 0; j < absn.length; j++){
    //         if (max == absn[j].alpa) {
    //             if (ketemu) {
    //                 System.out.println("Matkul: " + absn[j].mataKuliah.namaMK);
    //                 System.out.println("Jumlah Alpha: " + absn[j].alpa);
    //                 total += absn[j].alpa;
    //             } else {
    //                 System.out.println("Nama: " + absn[j].mahasiswa.namaMahasiswa);
    //                 System.out.println("NIM: " + absn[j].mahasiswa.nim);
    //                 System.out.println("Matkul: " + absn[j].mataKuliah.namaMK);
    //                 System.out.println("Jumlah Alpha: " + absn[j].alpa);
    //                 System.out.println();
    //                 total += absn[j].alpa;
    ...
    //     System.out.println("Jumlah total Alpa = " + total);
    // }
}
